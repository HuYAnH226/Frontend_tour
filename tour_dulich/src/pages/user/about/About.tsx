import { Mountain, Users, Handshake, Leaf } from "lucide-react";
import { Header } from "../../../components/layout/Header";
import { Footer } from "../../../components/layout/Footer";
import { Link } from "react-router-dom";
import anh9 from "../../../assets/a9.jpg";
import anh10 from "../../../assets/a10.avif";
export const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <Header />
      <section
        className="relative text-white py-24 md:py-32 bg-center bg-cover"
        style={{
          backgroundImage: `url(${anh10})`,
        }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
            Chào mừng đến với VietTravela! ✈️
          </h2>

          <p className="text-xl md:text-2xl max-w-4xl mx-auto font-light text-blue-100 drop-shadow-[0_2px_6px_rgba(0,0,0,0.7)]">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-16 md:items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="text-gray-700 leading-relaxed bg-blue-50 p-5 rounded-xl border-l-4 border-blue-500 shadow-inner">
                <p className="font-medium">
                  **VietTravela** được thành lập với niềm đam mê sâu sắc dành
                  cho du lịch Việt Nam. Chúng tôi tin rằng mỗi chuyến đi không
                  chỉ là việc ngắm cảnh mà còn là trải nghiệm văn hóa, ẩm thực,
                  và kết nối con người. Sứ mệnh của chúng tôi là mang đến những
                  tour du lịch **độc đáo, chất lượng cao, an toàn và bền vững**,
                  giúp du khách khám phá những viên ngọc ẩn của đất nước hình
                  chữ S.
                </p>
              </div>
            ...
            <div className="order-1 md:order-2 mt-12 md:mt-0 relative">
              <div className="order-1 md:order-2 mt-12 md:mt-0 relative">
               ...
               bg-center bg-cover border-4 border-white 
               transform rotate-3 hover:rotate-0 
               transition duration-500 ease-in-out"
                  style={{
                    backgroundImage: `url(${anh9})`,
                  }}
                ></div>
              </div>
            </div>
