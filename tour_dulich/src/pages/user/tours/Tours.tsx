...
import { Clock, Users, Search, SlidersHorizontal, X } from "lucide-react";
...
export default function Tour() {
  ...
  const categories = [{ id: "all", name: "Tất cả" }];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      >
        ...
        {/* Nội dung phải có z-index lớn hơn */}
              ...
              >
                ...
                <div className="relative h-48">
                  ...
                  <div
                    className={`fallback ${
                      tour.anhTour ? "hidden" : ""
                    } w-full h-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white text-6xl font-bold`}
                  >
